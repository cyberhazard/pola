export default {
  RU: {
    ...
    4: {
      name: 'ООО «Озерная Верфь»',
      text: 'Выйдя на рынок в 2005 году с концепцией «качественное строительство яхт класса «люкс» по индивидуальному заказу», в настоящий момент специализируется на производстве многоцелевых скоростных катеров.',
      site: 'http://lakyverf.com',
    },
    5: {
      name: 'Inok N.V. Ltd.',
  ...
  EN: {
    ...
    6: {
      name: 'Laky Verf LLC',
      text: 'Entering the market in 2005 with the concept of "quality construction of luxury class yachts" by an individual order ", is currently specialized in production of multi-purpose high-speed boats.',
      site: 'http://lakyverf.com',
    },
    7: {
      name: 'Inok N.V. Ltd.',
