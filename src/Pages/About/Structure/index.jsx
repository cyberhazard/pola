...
export default () => (
  <Page>
    ...
    <Block img={ship1} header="Pola Maritime Ltd." link="#">
    ...
    <Block img={ship3} header="ООО «Пола Райз»" link="#">
    ...
    <Block right img={ship4} header="ООО «Пола Менеджмент»" link="#">
    ...
    <Block img={ship5} header="Pola Logistic" link="#">
